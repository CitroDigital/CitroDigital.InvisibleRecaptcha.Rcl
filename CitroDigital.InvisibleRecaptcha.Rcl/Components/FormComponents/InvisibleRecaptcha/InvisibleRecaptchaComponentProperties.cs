...
{
    public class InvisibleRecaptchaComponentProperties : FormComponentProperties<string>
    {
        ...
        public InvisibleRecaptchaComponentProperties() : base(FieldDataType.Text)
        {
        }
        ...
        [Required]
        [EditingComponent(TextInputComponent.IDENTIFIER, Label = "Score", ExplanationText = SCORE_DESCRIPTION, Tooltip = SCORE_DESCRIPTION)]
